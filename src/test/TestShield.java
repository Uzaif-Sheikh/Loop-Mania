...
public class TestShield {
     ...
     */
    @Test
    public void testShieldDamage() throws FileNotFoundException {
        ...
        assertEquals(0.1, shield.getDamage("Slug"));
        assertEquals(0.2, shield.getDamage("Zombie"));
        assertEquals(0.3, shield.getDamage("Vampire"));

        double zombie_attack = zombie.getDamage();

        zombie.enemyAttack(character);
        assertEquals((int)(zombie_attack-0.2*zombie_attack), (int)(initial_ch_health - character.getHealth()));

        initial_ch_health = character.getHealth();

        double slug_attack = slug.getDamage();

        slug.enemyAttack(character);
        assertEquals((int) (slug_attack-0.1*slug_attack), (int) (initial_ch_health - character.getHealth()));
        ...
        assertEquals((int)(vampire_attack-0.3*vampire_attack), (int)(vampire_character_health - character.getHealth()));
