...
public class TestStaff {
     ...
     */
    @Test
    public void testStaffDamage() throws FileNotFoundException {
        ...
        double characterDamage = character.getDamage();
        ...
        assertEquals(zombie_health-(characterDamage+1), zombie.getHealth());
        ...
        assertEquals(vampire_health-(characterDamage+1), vampire.getHealth());
        assertEquals(slug_health-(characterDamage+1), slug.getHealth());

        assertEquals(1, staff.getDamage("Slug"));
        assertEquals(1, staff.getDamage("Zombie"));
        assertEquals(1, staff.getDamage("Vampire"));
